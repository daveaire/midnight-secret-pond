...
const _descriptor_3 = new __compactRuntime.CompactTypeVector(5, _descriptor_0);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateRouteHash) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateRouteHash');
    }
    if (typeof(witnesses_0.privateNetBps) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateNetBps');
    }
    if (typeof(witnesses_0.privateBridgeSeconds) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateBridgeSeconds');
    }
    if (typeof(witnesses_0.privateLiquidityUsd) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateLiquidityUsd');
    }
  ...
  _proveOpportunity_0(context, partialProofData) {
    ...
    __compactRuntime.assert(netBps_0
                            >=
    ...
    __compactRuntime.assert(bridgeSeconds_0
                            <=
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'Bridge is too slow');
    __compactRuntime.assert(liquidityUsd_0
                            >=
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
    ...
    const commitment_0 = this._opportunityCommitment_0(routeHash_0,
                                                       netBps_0,
                                                       bridgeSeconds_0,
                                                       liquidityUsd_0);
  ...
  _opportunityCommitment_0(routeHash_0,
                           netBps_0,
                           bridgeSeconds_0,
                           liquidityUsd_0)
  {
...
const _dummyContract = new Contract({
  ...
  privateNetBps: (...args) => undefined,
  privateBridgeSeconds: (...args) => undefined,
  privateLiquidityUsd: (...args) => undefined
});
export const pureCircuits = {
  opportunityCommitment: (...args_0) => {
    if (args_0.length !== 4) {
      throw new __compactRuntime.CompactError(`opportunityCommitment: expected 4 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    ...
    if (!(routeHash_0.buffer instanceof ArrayBuffer && routeHash_0.BYTES_PER_ELEMENT === 1 && routeHash_0.length === 32)) {
      __compactRuntime.typeError('opportunityCommitment',
                                 'argument 1',
    ...
    return _dummyContract._opportunityCommitment_0(routeHash_0,
                                                   netBps_0,
                                                   bridgeSeconds_0,
                                                   liquidityUsd_0);
  }
