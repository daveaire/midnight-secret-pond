/**
 * Deploy Secret Pond Proof to a Midnight network (local devnet by default;
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy Secret Pond Proof to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      // empty for Secret Pond Proof's no-arg constructor. (Statically-typed contracts can omit
  ...
  console.log('  Next: npm run network:prove\n');
}
